...
class KafkaProducerConfig {
    ...
    @Bean
    fun chatMessageBroadcastProducerFactory(): ProducerFactory<Long, ChatMessageBroadcast> {
        ...
        val producerFactory = DefaultKafkaProducerFactory<Long, ChatMessageBroadcast>(config)
    ...
    @Bean
    fun chatMessageBroadcastKafkaTemplate(): KafkaTemplate<Long, ChatMessageBroadcast> {
        return KafkaTemplate(chatMessageBroadcastProducerFactory())
    }
}